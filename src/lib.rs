...
#[derive(Debug)]
pub struct CryptoManagerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CryptoManagerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    let mut processor = CryptoManagerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CryptoManagerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CryptoManagerProcessor::new(false);
